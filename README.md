...
This project is derived from [MIT PDOS xv6](https://github.com/mit-pdos/xv6-public). Most components follow xv6's design, while this repo ports the system to amd64/UEFI and adds project-specific changes.
